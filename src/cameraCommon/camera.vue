<template>
    <div class="box" :style="{'backgroundImage': 'url('+bg+')', 'backgroundSize': num}" @click="showBigPhoto">
        ...
        <div>
            <zoomImgCommon :bgSrc="bgSrc" @closeZoomImg="closeZoomImg"></zoomImgCommon>
        </div>       
    </div>
</template>
...
import zoomImgCommon from '@/components/zoomImg/zoomImg.vue';
export default {
    data () {
        return {
            bg: require('./add.png'),
            ...
            filePhoto: true,
            num: 'auto',
            bgSrc:'http://img5.imgtn.bdimg.com/it/u=3300305952,1328708913&fm=26&gp=0.jpg',
            showAddCar: false
        } 
    },
    components: {
    ...
    methods: {
        ...
        closeBox () {
            ...
            document.body.removeEventListener('touchmove', this.preventHandle, false);
        },        
        fn (e) {
            let obj = e.target;
